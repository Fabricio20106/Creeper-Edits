...
import com.sophicreeper.creeperedits.util.CEArmorMaterials;
...
public class CEItems {
    ...
    public static final RegistryObject<Item> CREEPER_HELMET = ITEMS.register("creeper_helmet", () -> new ArmorItem(CEArmorMaterials.CREEPER, EquipmentSlotType.HEAD, new Item.Properties().tab(CETab.TAB)));
    public static final RegistryObject<Item> CREEPER_CHESTPLATE = ITEMS.register("creeper_chestplate", () -> new ArmorItem(CEArmorMaterials.CREEPER, EquipmentSlotType.CHEST, new Item.Properties().tab(CETab.TAB)));
    public static final RegistryObject<Item> CREEPER_LEGGINGS = ITEMS.register("creeper_leggings", () -> new ArmorItem(CEArmorMaterials.CREEPER, EquipmentSlotType.LEGS, new Item.Properties().tab(CETab.TAB)));
    public static final RegistryObject<Item> CREEPER_BOOTS = ITEMS.register("creeper_boots", () -> new ArmorItem(CEArmorMaterials.CREEPER, EquipmentSlotType.FEET, new Item.Properties().tab(CETab.TAB)));
    public static final RegistryObject<Item> CREEPER_LORD_HELMET = ITEMS.register("creeper_lord_helmet", () -> new CreeperLordArmorItem(CEArmorMaterials.CREEPER_LORD, EquipmentSlotType.HEAD, new Item.Properties().rarity(Rarity.UNCOMMON).tab(CETab.TAB)));
    ...
    public static final RegistryObject<Item> CREEPER_HORSE_ARMOR = ITEMS.register("creeper_horse_armor", () -> new HorseArmorItem(7, CreeperEdits.resourceLoc("textures/entity/horse/armor/horse_armor_creeper.png"), new Item.Properties().stacksTo(1).tab(CETab.TAB)));
